...
class DataIngestion:
    ...
    def export_data_into_features(self,dataframe:pd.DataFrame):
        try:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataframe=self.export_data_into_features(dataframe) 
            self.split_data_as_train_test(dataframe)
            dataingesionartifact=DataIngestionArtifact(trained_file_path=self.data_ingestion_config.training_file_path,
